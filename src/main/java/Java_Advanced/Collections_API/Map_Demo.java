...
public class Map_Demo {
    public static void main(String[] args) {
        ...
        myHashMap.put(1,"First Change"); //If Key=1 is Present. will replace value orElse will add another entry
        ...
        myHashMap.replace(8,"pqr"); // Here replace will do nothing as Key 8 doesn't exist
